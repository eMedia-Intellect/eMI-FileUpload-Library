	...
	if ($Upload->GetHasUploaded())
	{
		if (!$Upload->GetHasUploadFailure())
		{
			...
			if (!empty($Upload->GetFiles()))
			{
				...
				{
					$file->SetDestinationName("file$counter");
			...
			{
				$Output .= $Indentation . "<p>No nonempty files were uploaded!</p>\n";
			}
		}
		else
		{
...
<html dir="ltr" lang="en-GB">
	<head>
		...
		<meta charset="UTF-8"/>
		<title>Renaming files before storage – eMI PHP FileUpload Library</title>
	</head>
	<body>
		<h1>Renaming files before storage</h1>
