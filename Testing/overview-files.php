...
if (basename($_SERVER['SCRIPT_FILENAME']) === 'overview-files.php')
{
	exit('This file can not be directly executed but only included.');
}

$Output .= $Indentation . "<table>\n";
$Output .= $Indentation . "	<caption>Overview of files</caption>\n";

$Output .= $Indentation . "	<tr>\n";
$Output .= $Indentation . "		<th>GetEmptyFiles():</th>\n";
$Output .= $Indentation . '		<td>' . count($Upload->GetEmptyFiles()) . "</td>\n";
$Output .= $Indentation . "	</tr>\n";

$Output .= $Indentation . "	<tr>\n";
$Output .= $Indentation . "		<th>GetNonEmptyFiles():</th>\n";
$Output .= $Indentation . '		<td>' . count($Upload->GetNonEmptyFiles()) . "</td>\n";
$Output .= $Indentation . "	</tr>\n";

$Output .= $Indentation . "	<tr>\n";
$Output .= $Indentation . "		<th>GetFiles():</th>\n";
$Output .= $Indentation . '		<td>' . count($Upload->GetFiles()) . "</td>\n";
$Output .= $Indentation . "	</tr>\n";
