...
require_once 'Exceptions/InvalidErrorCodeException.php';
require_once 'Exceptions/NoFilesUploadedException.php';
require_once 'Exceptions/NoTemporaryDirectoryException.php';
require_once 'Exceptions/UnknownErrorCodeException.php';
